            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr v-for="info in paginatedShippingInfos" :key="info.id">
          ...
          <div class="modal-wrapper delete-modal-wrapper">
            <div class="modal-container delete-modal-container">
              <div class="modal-header delete-modal-header">
                ...
                <h3>Confirm deletion of shipping address</h3>
                <button class="modal-close" @click="showDeleteModal = false">×</button>
              </div>
              <div class="modal-body delete-modal-body">
                <p v-if="selectedShipping" class="delete-modal-title">Are you sure you want to delete this shipping address?</p>
...
export default {
  ...
  computed: {
    paginatedShippingInfos() {
      const start = (this.currentPage - 1) * this.itemsPerPage;
      const end = start + this.itemsPerPage;
      return this.shippingInfos.slice(start, end);
    },
    totalPages() {
      return Math.ceil(this.shippingInfos.length / this.itemsPerPage);
    },
    displayedPages() {
      const pages = [];
