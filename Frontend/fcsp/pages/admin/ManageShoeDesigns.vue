<template>
  ...
  export default {
    ...
    //     // Initialize modals
    //     this.designDetailsModal = new bootstrap.Modal(this.$refs.designDetailsModal);
    //     this.editDesignModal = new bootstrap.Modal(this.$refs.editDesignModal);
    //     this.deleteDesignModal = new bootstrap.Modal(this.$refs.deleteDesignModal);
    //   }
    },
    mounted() {
